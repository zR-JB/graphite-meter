// Application states for the WebTransport Download Client
export const AppState = {
    INIT: 'init',                           // Initial state, no connection
    CONNECTING: 'connecting',               // Attempting to establish connection(s)
    CONNECTED: 'connected',                 // Connected but not downloading
    WARMUP: 'warmup',                        // Preparing download (e.g., sending control message)
    RUNNING: 'running',                      // Actively downloading
    STOPPING: 'stopping',                    // Stop requested, finishing remaining data
    STOPPED_WITH_RESULTS: 'stopped_with_results', // Download stopped, results available
