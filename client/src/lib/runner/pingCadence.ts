...
/** Fixed start-to-start ping intervals shared by every runner and by the
 * adaptive evidence policy. Reply-driven pacing has no configured interval. */
export const FIXED_PING_INTERVAL_MS = {
  fast: 80,
  medium: 250,
  slow: 600,
